...
function vp_sync_tables() {
	...
	$defs = array(
		...
		'pp_top_schritte'        => array( 'pp_top_schritte',         'id', null,            'pp_manage', null ),
		'pp_ablauf_vorlagen'     => array( 'pp_ablauf_vorlagen',      'id', 'erstellt_am',   'pp_manage', null ),
		'pp_ablauf_vorlage_schritte' => array( 'pp_ablauf_vorlage_schritte', 'id', null,     'pp_manage', null ),
		'pp_dokumente'           => array( 'pp_dokumente',            'id', 'erstellt_am',   'pp_manage', null ),
		'pp_dokument_paragraphen'=> array( 'pp_dokument_paragraphen', 'id', 'geaendert_am',  'pp_manage', null ),
		'pp_paragraph_kommentare'=> array( 'pp_paragraph_kommentare', 'id', 'erstellt_am',   'pp_manage', null ),
