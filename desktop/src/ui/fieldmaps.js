...
const T = {
  ...
  jb_buchungen: {
    ...
    fields: {
      ...
      beleg_pfad: { label: 'Beleg-Pfad (Nextcloud)' },
      budget_id: {
        label: 'Budget belasten',
        type: 'select',
        from: { slug: 'jb_budgets', value: 'id', label: (r) => `${r.zweck}${r.kostenstelle ? ' · ' + r.kostenstelle : ''}` },
      },
      kostenstelle: {
        label: 'Kostenstelle',
        type: 'datalist',
        from: { slug: 'jb_budgets', value: 'kostenstelle', label: (r) => r.kostenstelle },
      },
      auslage_id: {
        label: 'Auslage',
        type: 'select',
